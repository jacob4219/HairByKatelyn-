...
<div className="booking-details">
      ...
      <p>To reschedule an appointment or book an appointment after 4pm please <Link to="/contact">Contact Me.</Link></p>
        <div className="book-online-link">
        <Link to="/contact"><p className="book-online-text">Contact Me</p></Link> </div>
      <div className="book-online-link">
